...
public class NavUtils {
    ...
    static class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            if (parentActivityName != null) {
                ...
                try {
                    intent = NavUtils.getParentActivityName(activity, componentName) == null ? IntentCompat.makeMainActivity_quran(componentName) : new Intent().setComponent(componentName);
    ...
    public static Intent getParentActivityIntent(Context context, ComponentName componentName) throws PackageManager.NameNotFoundException {
        ...
        return getParentActivityName(context, componentName2) == null ? IntentCompat.makeMainActivity_quran(componentName2) : new Intent().setComponent(componentName2);
    }
    ...
    public static Intent getParentActivityIntent(Context context, Class<?> cls) throws PackageManager.NameNotFoundException {
        ...
        return getParentActivityName(context, componentName) == null ? IntentCompat.makeMainActivity_quran(componentName) : new Intent().setComponent(componentName);
    }
