...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    public void performCreate(Bundle bundle) {
        ...
        } else if (bundle != null && (parcelable = bundle.getParcelable(C001000l.A05)) != null) {
            if (this.mChildFragmentManager == null) {
                instantiateChildFragmentManager();
            }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        if (this.mChildFragmentManager != null && (saveAllState = this.mChildFragmentManager.saveAllState()) != null) {
            bundle.putParcelable(C001000l.A05, saveAllState);
        }
    }
    ...
    public void startActivityForResult(Intent intent, int i2) {
        ...
        this.mActivity.startActivityFromFragment(this, intent, i2);
    }
