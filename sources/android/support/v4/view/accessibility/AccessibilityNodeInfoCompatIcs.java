...
class AccessibilityNodeInfoCompatIcs {
    ...
    public static void addAction(Object obj, int i2) {
    ...
    public static Object getChild(Object obj, int i2) {
        return ((AccessibilityNodeInfo) obj).getChild(i2);
    }
    ...
    public static boolean performAction(Object obj, int i2) {
        return ((AccessibilityNodeInfo) obj).performAction(i2);
    }
    ...
    public static void setCheckable(Object obj, boolean z2) {
        ((AccessibilityNodeInfo) obj).setCheckable(z2);
    }

    public static void setChecked(Object obj, boolean z2) {
    ...
    public static void setClickable(Object obj, boolean z2) {
    ...
    public static void setEnabled(Object obj, boolean z2) {
        ((AccessibilityNodeInfo) obj).setEnabled(z2);
    }

    public static void setFocusable(Object obj, boolean z2) {
        ((AccessibilityNodeInfo) obj).setFocusable(z2);
    }

    public static void setFocused(Object obj, boolean z2) {
        ((AccessibilityNodeInfo) obj).setFocused(z2);
    }

    public static void setLongClickable(Object obj, boolean z2) {
    ...
    public static void setPassword(Object obj, boolean z2) {
        ((AccessibilityNodeInfo) obj).setPassword(z2);
    }

    public static void setScrollable(Object obj, boolean z2) {
        ((AccessibilityNodeInfo) obj).setScrollable(z2);
    }

    public static void setSelected(Object obj, boolean z2) {
