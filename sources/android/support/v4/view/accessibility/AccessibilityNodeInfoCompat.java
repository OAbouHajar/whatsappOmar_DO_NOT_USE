...
public class AccessibilityNodeInfoCompat {
    ...
    static class AccessibilityNodeInfoIcsImpl extends AccessibilityNodeInfoStubImpl {
        ...
        public void addAction(Object obj, int i2) {
            AccessibilityNodeInfoCompatIcs.addAction(obj, i2);
        }
        ...
        public Object getChild(Object obj, int i2) {
            return AccessibilityNodeInfoCompatIcs.getChild(obj, i2);
        }
        ...
        public boolean performAction(Object obj, int i2) {
            return AccessibilityNodeInfoCompatIcs.performAction(obj, i2);
        }
        ...
        public void setCheckable(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setCheckable(obj, z2);
        }

        public void setChecked(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setChecked(obj, z2);
        }
        ...
        public void setClickable(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setClickable(obj, z2);
        }
        ...
        public void setEnabled(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setEnabled(obj, z2);
        }

        public void setFocusable(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setFocusable(obj, z2);
        }

        public void setFocused(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setFocused(obj, z2);
        }

        public void setLongClickable(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setLongClickable(obj, z2);
        }
        ...
        public void setPassword(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setPassword(obj, z2);
        }

        public void setScrollable(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setScrollable(obj, z2);
        }

        public void setSelected(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatIcs.setSelected(obj, z2);
        }
    ...
    static class AccessibilityNodeInfoJellybeanImpl extends AccessibilityNodeInfoIcsImpl {
        ...
        public void addChild(Object obj, View view, int i2) {
            AccessibilityNodeInfoCompatJellyBean.addChild(obj, view, i2);
        }

        public Object findFocus(Object obj, int i2) {
            return AccessibilityNodeInfoCompatJellyBean.findFocus(obj, i2);
        }

        public Object focusSearch(Object obj, int i2) {
            return AccessibilityNodeInfoCompatJellyBean.focusSearch(obj, i2);
        }
        ...
        public Object obtain(View view, int i2) {
            return AccessibilityNodeInfoCompatJellyBean.obtain(view, i2);
        }

        public boolean performAction(Object obj, int i2, Bundle bundle) {
            return AccessibilityNodeInfoCompatJellyBean.performAction(obj, i2, bundle);
        }

        public void setAccessibilityFocused(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatJellyBean.setAccesibilityFocused(obj, z2);
        }

        public void setMovementGranularities(Object obj, int i2) {
            AccessibilityNodeInfoCompatJellyBean.setMovementGranularities(obj, i2);
        }

        public void setParent(Object obj, View view, int i2) {
            AccessibilityNodeInfoCompatJellyBean.setParent(obj, view, i2);
        }

        public void setSource(Object obj, View view, int i2) {
            AccessibilityNodeInfoCompatJellyBean.setSource(obj, view, i2);
        }

        public void setVisibleToUser(Object obj, boolean z2) {
            AccessibilityNodeInfoCompatJellyBean.setVisibleToUser(obj, z2);
        }
    }
    ...
    public static AccessibilityNodeInfoCompat obtain(View view, int i2) {
        return wrapNonNullInstance(IMPL.obtain(view, i2));
    }
    ...
    public void addChild(View view, int i2) {
        IMPL.addChild(this.mInfo, view, i2);
    }
    ...
    public AccessibilityNodeInfoCompat findFocus(int i2) {
        return wrapNonNullInstance(IMPL.findFocus(this.mInfo, i2));
    }

    public AccessibilityNodeInfoCompat focusSearch(int i2) {
        return wrapNonNullInstance(IMPL.focusSearch(this.mInfo, i2));
    }
    ...
    public AccessibilityNodeInfoCompat getChild(int i2) {
        return wrapNonNullInstance(IMPL.getChild(this.mInfo, i2));
    }
    ...
    public boolean performAction(int i2) {
        return IMPL.performAction(this.mInfo, i2);
    }

    public boolean performAction(int i2, Bundle bundle) {
        return IMPL.performAction(this.mInfo, i2, bundle);
    }
    ...
    public void setParent(View view, int i2) {
        IMPL.setParent(this.mInfo, view, i2);
    }
    ...
    public void setSource(View view, int i2) {
        IMPL.setSource(this.mInfo, view, i2);
    }
