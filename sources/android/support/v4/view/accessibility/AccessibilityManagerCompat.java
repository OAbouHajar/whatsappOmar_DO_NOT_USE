...
public class AccessibilityManagerCompat {
    ...
    static class AccessibilityManagerIcsImpl extends AccessibilityManagerStubImpl {
        ...
        public List<AccessibilityServiceInfo> getEnabledAccessibilityServiceList(AccessibilityManager accessibilityManager, int i2) {
            return AccessibilityManagerCompatIcs.getEnabledAccessibilityServiceList(accessibilityManager, i2);
        }
        ...
        public Object newAccessiblityStateChangeListener(final AccessibilityStateChangeListenerCompat accessibilityStateChangeListenerCompat) {
            return AccessibilityManagerCompatIcs.newAccessibilityStateChangeListener(new AccessibilityManagerCompatIcs.AccessibilityStateChangeListenerBridge() {
                public void onAccessibilityStateChanged(boolean z2) {
                    accessibilityStateChangeListenerCompat.onAccessibilityStateChanged(z2);
                }
            });
        }
    ...
    interface AccessibilityManagerVersionImpl {
        ...
        List<AccessibilityServiceInfo> getEnabledAccessibilityServiceList(AccessibilityManager accessibilityManager, int i2);
    ...
    public static abstract class AccessibilityStateChangeListenerCompat {
        ...
        public abstract void onAccessibilityStateChanged(boolean z2);
    }
    ...
    public static List<AccessibilityServiceInfo> getEnabledAccessibilityServiceList(AccessibilityManager accessibilityManager, int i2) {
        return IMPL.getEnabledAccessibilityServiceList(accessibilityManager, i2);
    }
