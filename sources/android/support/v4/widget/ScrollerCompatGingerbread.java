...
class ScrollerCompatGingerbread {
    ...
    public static void fling(Object obj, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ((OverScroller) obj).fling(i2, i3, i4, i5, i6, i7, i8, i9);
    }

    public static void fling(Object obj, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11) {
    ...
    public static void notifyHorizontalEdgeReached(Object obj, int i2, int i3, int i4) {
        ((OverScroller) obj).notifyHorizontalEdgeReached(i2, i3, i4);
    }

    public static void notifyVerticalEdgeReached(Object obj, int i2, int i3, int i4) {
        ((OverScroller) obj).notifyVerticalEdgeReached(i2, i3, i4);
    }

    public static void startScroll(Object obj, int i2, int i3, int i4, int i5) {
        ((OverScroller) obj).startScroll(i2, i3, i4, i5);
    }

    public static void startScroll(Object obj, int i2, int i3, int i4, int i5, int i6) {
