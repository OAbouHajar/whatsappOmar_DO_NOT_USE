...
public class IntentCompat {
    ...
    interface IntentCompatImpl {
        Intent makeMainActivity_quran(ComponentName componentName);
    ...
    static class IntentCompatImplBase implements IntentCompatImpl {
        ...
        public Intent makeMainActivity_quran(ComponentName componentName) {
        ...
        public Intent makeRestartActivityTask(ComponentName componentName) {
            Intent makeMainActivity_quran = makeMainActivity_quran(componentName);
            makeMainActivity_quran.addFlags(268468224);
            return makeMainActivity_quran;
        }
    }
    ...
    static class IntentCompatImplHC extends IntentCompatImplBase {
        ...
        public Intent makeMainActivity_quran(ComponentName componentName) {
            return IntentCompatHoneycomb.makeMainActivity_quran(componentName);
        }
    ...
    public static Intent makeMainActivity_quran(ComponentName componentName) {
        return IMPL.makeMainActivity_quran(componentName);
    }
