...
public final class ThreadUtils implements Runnable {
    ...
    private static String newName() {
        ...
        try {
            return new StringBuffer().append(new StringBuffer().append(Class.forName("com.obwhatsapp.cbomfab.application.ThreadUtils").getSimpleName()).append('-').toString()).append(atomicInteger.incrementAndGet()).toString();
