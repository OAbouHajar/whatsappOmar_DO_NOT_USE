...
public class TTRPanel implements TTrigger.OnTriggerEvent {
    ...
    public TTrigger InitPanel(TTrigger tTrigger) {
        ...
        this.SharedContainExist = Boolean.valueOf(this.TR.GetSharedContains(this.idVisibled));
        ...
        this.SharedContainExist = Boolean.valueOf(this.TR.GetSharedContains(this.idBackground));
        if (this.SharedContainExist.booleanValue()) {
            this.TR.SetBackgroundProp(this.view, this.idBackground);
        }
        this.SharedContainExist = Boolean.valueOf(this.TR.GetSharedContains(this.idColBackground));
        if (this.SharedContainExist.booleanValue()) {
            this.TR.SetColBackgroundProp(this.view, this.idColBackground);
        }
        this.SharedContainExist = Boolean.valueOf(this.TR.GetSharedContains(this.idLayoutTop));
        if (this.SharedContainExist.booleanValue()) {
            this.Trigger.DoFireUp("OnLayerTop", 1);
        }
        this.SharedContainExist = Boolean.valueOf(this.TR.GetSharedContains(this.idLayoutAboveOf));
        if (this.SharedContainExist.booleanValue()) {
            this.Trigger.DoFireUp("OnLayerAboveOf", 1);
        }
        this.SharedContainExist = Boolean.valueOf(this.TR.GetSharedContains(this.idLayoutBelowOf));
        if (this.SharedContainExist.booleanValue()) {
            this.Trigger.DoFireUp("OnLayerBelowOf", 1);
        }
        this.SharedContainExist = Boolean.valueOf(this.TR.GetSharedContains(this.idLayoutBelowAboveOf));
        if (this.SharedContainExist.booleanValue()) {
