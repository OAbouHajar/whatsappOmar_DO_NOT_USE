...
public abstract class Hilt_VoipActivityV2_SwitchConfirmationFragment extends WaDialogFragment {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.voipcalling.Hilt_VoipActivityV2_SwitchConfirmationFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            AnonymousClass3K2.A18(r0, switchConfirmationFragment);
            switchConfirmationFragment.A00 = C16150sX.A0Y(r0);
        }
    }
