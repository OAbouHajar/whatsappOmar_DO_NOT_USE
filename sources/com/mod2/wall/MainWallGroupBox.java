...
public class MainWallGroupBox extends LinearLayout implements TTrigger.OnTriggerEvent {
    private TTRPanel TRPanel;
    private TTrigger Trigger;

    public MainWallGroupBox(Context context, AttributeSet attributeSet) {
    ...
    public MainWallGroupBox(Context context, AttributeSet attributeSet, Boolean bool) {
        super(context, attributeSet);
        if (!isInEditMode()) {
            this.Trigger = new TTrigger(context, this);
