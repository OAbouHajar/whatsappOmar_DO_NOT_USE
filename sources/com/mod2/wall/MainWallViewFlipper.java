...
public class MainWallViewFlipper extends ViewFlipper implements TTrigger.OnTriggerEvent {
    private TTRPanel TRPanel;
    private TTrigger Trigger;

    public MainWallViewFlipper(Context context, AttributeSet attributeSet) {
    ...
    public MainWallViewFlipper(Context context, AttributeSet attributeSet, Boolean bool) {
        super(context, attributeSet);
        if (!isInEditMode()) {
            this.Trigger = new TTrigger(context, this);
