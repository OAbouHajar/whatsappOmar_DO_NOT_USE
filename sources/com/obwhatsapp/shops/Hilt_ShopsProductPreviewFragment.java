...
public abstract class Hilt_ShopsProductPreviewFragment extends ShopsBkFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.shops.Hilt_ShopsProductPreviewFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1H() {
        if (!this.A02) {
            ...
            shopsProductPreviewFragment.A06 = C17270uo.A00(r1.AJv);
            shopsProductPreviewFragment.A07 = (C228319l) r1.AMS.get();
            shopsProductPreviewFragment.A05 = C16150sX.A0m(r1);
            shopsProductPreviewFragment.A03 = C16150sX.A03(r1);
            shopsProductPreviewFragment.A04 = (C25821Lg) r1.AMI.get();
        }
    }
