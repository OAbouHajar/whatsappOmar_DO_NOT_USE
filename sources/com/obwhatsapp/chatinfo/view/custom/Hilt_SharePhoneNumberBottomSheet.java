...
public abstract class Hilt_SharePhoneNumberBottomSheet extends PnhBottomSheet {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.chatinfo.view.custom.Hilt_SharePhoneNumberBottomSheet.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            C16150sX A0P = AnonymousClass3K2.A0P(sharePhoneNumberBottomSheet, (C17060uT) generatedComponent());
            sharePhoneNumberBottomSheet.A01 = (C17110uY) A0P.ADT.get();
            sharePhoneNumberBottomSheet.A00 = (AnonymousClass01Y) A0P.A1w.get();
        }
    }
}
