...
public abstract class Hilt_ChangeEphemeralSettingsDialog extends WaDialogFragment {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.ephemeral.Hilt_ChangeEphemeralSettingsDialog.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            AnonymousClass3K2.A18(r0, changeEphemeralSettingsDialog);
            changeEphemeralSettingsDialog.A00 = (C17120uZ) r0.AQT.get();
        }
    }
