...
public class GalleryWallpaperPreview extends C78233xY {
    public int A00;
    public Uri A01;
    public PhotoView A02;
    public C222617g A03;
    public C16210se A04;
    public AnonymousClass1A9 A05;
    public boolean A06;
    ...
    public void A37(X.C15830rv r13) {
        ...
        L_0x00e0:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.settings.chat.wallpaper.GalleryWallpaperPreview.A37(X.0rv):void");
    }

    /* JADX WARNING: Code restructure failed: missing block: B:36:0x01a7, code lost:
        if (r5 != null) goto L_0x01a9;
     */
    /* JADX WARNING: Missing exception handler attribute for start block: B:52:0x0209 */
    /* JADX WARNING: Unknown top exception splitter block from list: {B:52:0x0209=Splitter:B:52:0x0209, B:44:0x01ee=Splitter:B:44:0x01ee} */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void onCreate(android.os.Bundle r19) {
        /*
            ...
            boolean r0 = r1 instanceof com.obwhatsapp.settings.chat.wallpaper.YoGalleryWallpaperPreview
        ...
        L_0x00eb:
            ...
            return
        L_0x00f2:
            android.graphics.Point r7 = new android.graphics.Point     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            r7.<init>()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            X.C13680ns.A0s(r1, r7)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            X.1A9 r0 = r1.A05     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            java.io.InputStream r4 = r0.A0b(r6, r5)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            android.graphics.BitmapFactory$Options r13 = new android.graphics.BitmapFactory$Options     // Catch:{ all -> 0x0205 }
            r13.<init>()     // Catch:{ all -> 0x0205 }
            android.graphics.Bitmap$Config r0 = android.graphics.Bitmap.Config.RGB_565     // Catch:{ all -> 0x0205 }
            r13.inPreferredConfig = r0     // Catch:{ all -> 0x0205 }
            r13.inDither = r5     // Catch:{ all -> 0x0205 }
            int r15 = r7.x     // Catch:{ all -> 0x0205 }
            int r0 = r7.y     // Catch:{ all -> 0x0205 }
            r14 = 0
            r17 = 0
            X.25c r12 = new X.25c     // Catch:{ all -> 0x0205 }
            r16 = r0
            r12.<init>(r13, r14, r15, r16, r17)     // Catch:{ all -> 0x0205 }
            X.25d r0 = X.C37741pe.A04(r14, r12, r4, r11)     // Catch:{ all -> 0x0205 }
            android.graphics.Bitmap r10 = r0.A02     // Catch:{ all -> 0x0205 }
            r4.close()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            java.lang.String r4 = "not-a-image"
            java.lang.String r9 = "gallerywallpaperpreview/failed to load bitmap"
            if (r10 == 0) goto L_0x01ee
            int r0 = r10.getWidth()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            if (r0 == 0) goto L_0x01ee
            int r0 = r10.getHeight()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            if (r0 == 0) goto L_0x01ee
            X.01V r0 = r1.A08     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            android.content.ContentResolver r0 = r0.A0C()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            android.graphics.Matrix r15 = X.C17970vw.A09(r0, r6)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            if (r15 != 0) goto L_0x0144
            android.graphics.Matrix r15 = X.AnonymousClass000.A0H()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
        L_0x0144:
            int r13 = r10.getWidth()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            int r14 = r10.getHeight()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            r12 = 0
            r16 = 1
            android.graphics.Bitmap r6 = android.graphics.Bitmap.createBitmap(r10, r11, r12, r13, r14, r15, r16)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            if (r10 == r6) goto L_0x0158
            r10.recycle()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
        L_0x0158:
            r5 = r6
            android.graphics.Point r7 = new android.graphics.Point     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            r7.<init>()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            X.C13680ns.A0s(r1, r7)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            int r0 = r7.x     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r8 = (float) r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            int r0 = r6.getWidth()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r0 = (float) r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r8 = r8 / r0
            int r0 = r7.y     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r7 = (float) r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            int r0 = r6.getHeight()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r0 = (float) r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r7 = r7 / r0
            float r7 = java.lang.Math.max(r8, r7)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            r0 = 1065353216(0x3f800000, float:1.0)
            int r0 = (r7 > r0 ? 1 : (r7 == r0 ? 0 : -1))
            if (r0 <= 0) goto L_0x01a2
            java.lang.String r0 = "gallerywallpaperpreview/scaling image by "
            java.lang.StringBuilder r5 = X.AnonymousClass000.A0r(r0)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            r5.append(r7)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            java.lang.String r0 = "x to fit screen"
            java.lang.String r0 = X.AnonymousClass000.A0h(r0, r5)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            com.whatsapp.util.Log.i((java.lang.String) r0)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            int r0 = r6.getWidth()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r0 = (float) r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r0 = r0 * r7
            int r5 = (int) r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            int r0 = r6.getHeight()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r0 = (float) r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            float r0 = r0 * r7
            int r0 = (int) r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            android.graphics.Bitmap r5 = android.graphics.Bitmap.createScaledBitmap(r6, r5, r0, r2)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
        L_0x01a2:
            if (r5 == r6) goto L_0x01a9
            r6.recycle()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
        ...
        L_0x01e1:
            ...
            goto L_0x00eb
        L_0x01ee:
            com.whatsapp.util.Log.e((java.lang.String) r9)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            if (r10 == 0) goto L_0x01f6
            r10.recycle()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
        L_0x01f6:
            android.content.Intent r0 = X.C13680ns.A09()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            android.content.Intent r0 = r0.putExtra(r4, r5)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            r1.setResult(r11, r0)     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            r1.finish()     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
            goto L_0x0224
        L_0x0205:
            r0 = move-exception
            r4.close()     // Catch:{ all -> 0x0209 }
        L_0x0209:
            throw r0     // Catch:{ IOException -> 0x0218, OutOfMemoryError -> 0x020a }
        L_0x020a:
            r3 = move-exception
        ...
        L_0x0224:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.settings.chat.wallpaper.GalleryWallpaperPreview.onCreate(android.os.Bundle):void");
    }
