...
public abstract class Hilt_ProductMoreInfoFragment extends RoundedBottomSheetDialogFragment {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.biz.product.view.fragment.Hilt_ProductMoreInfoFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            C16150sX A0P = AnonymousClass3K2.A0P(productMoreInfoFragment, (C17060uT) generatedComponent());
            productMoreInfoFragment.A09 = C16150sX.A0Z(A0P);
            productMoreInfoFragment.A0A = (C18160wF) A0P.A5o.get();
        }
    }
}
