...
public abstract class Hilt_SetEmailFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r4) {
        ...
        L_0x0010:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.twofactor.Hilt_SetEmailFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            setEmailFragment.A00 = (C17070uU) r1.ABg.get();
            setEmailFragment.A01 = (C17080uV) r1.APK.get();
            setEmailFragment.A05 = (AnonymousClass01V) r1.AOi.get();
        }
    }
