...
public abstract class Hilt_SetCodeFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.twofactor.Hilt_SetCodeFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            setCodeFragment.A05 = (C14860ps) C16150sX.A01(setCodeFragment, (C17060uT) generatedComponent()).API.get();
        }
    }
