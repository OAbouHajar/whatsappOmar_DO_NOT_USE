...
public abstract class Hilt_AlertCardListFragment extends WaDialogFragment {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.framework.alerts.ui.Hilt_AlertCardListFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            C16150sX r1 = r3.A0b;
            AnonymousClass3K2.A18(r1, alertCardListFragment);
            alertCardListFragment.A02 = C16150sX.A0n(r1);
            alertCardListFragment.A01 = (C82244Cb) r3.A0K.get();
            alertCardListFragment.A03 = (AnonymousClass1PK) r1.A0W.get();
        }
    }
