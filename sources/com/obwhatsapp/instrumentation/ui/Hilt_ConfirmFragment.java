...
public abstract class Hilt_ConfirmFragment extends AnonymousClass01A implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.instrumentation.ui.Hilt_ConfirmFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            this.A02 = true;
            ((ConfirmFragment) this).A00 = (C23071Aj) ((C17050uS) ((C17060uT) generatedComponent())).A0b.AQb.get();
        }
    }
