...
public abstract class Hilt_EncryptionKeyFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.backup.encryptedbackup.Hilt_EncryptionKeyFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            C16150sX A012 = C16150sX.A01(encryptionKeyFragment, (C17060uT) generatedComponent());
            encryptionKeyFragment.A02 = C16150sX.A0T(A012);
            encryptionKeyFragment.A03 = C16150sX.A0Z(A012);
        }
    }
