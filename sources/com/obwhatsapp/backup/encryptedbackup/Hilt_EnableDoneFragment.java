...
public abstract class Hilt_EnableDoneFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.backup.encryptedbackup.Hilt_EnableDoneFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            C16150sX.A1E(r1, enableDoneFragment);
            enableDoneFragment.A00 = C16150sX.A0T(r1);
            enableDoneFragment.A01 = C16150sX.A0Y(r1);
        }
    }
