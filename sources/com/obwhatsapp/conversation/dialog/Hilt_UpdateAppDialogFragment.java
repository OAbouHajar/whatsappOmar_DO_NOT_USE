...
public abstract class Hilt_UpdateAppDialogFragment extends WaDialogFragment {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.conversation.dialog.Hilt_UpdateAppDialogFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            AnonymousClass3K2.A18(r1, updateAppDialogFragment);
            updateAppDialogFragment.A01 = (C18890xQ) r1.APS.get();
            updateAppDialogFragment.A00 = AnonymousClass3K3.A0a(r1);
        }
    }
