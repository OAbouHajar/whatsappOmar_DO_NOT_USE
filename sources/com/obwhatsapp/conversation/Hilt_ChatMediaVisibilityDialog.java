...
public abstract class Hilt_ChatMediaVisibilityDialog extends WaDialogFragment {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.conversation.Hilt_ChatMediaVisibilityDialog.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            AnonymousClass3K2.A18(r0, chatMediaVisibilityDialog);
            chatMediaVisibilityDialog.A04 = (C16220sf) r0.A3y.get();
        }
    }
