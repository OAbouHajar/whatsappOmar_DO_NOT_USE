...
public abstract class Hilt_BanAppealBannedDecisionFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.userban.ui.fragment.Hilt_BanAppealBannedDecisionFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            C16150sX A012 = C16150sX.A01(banAppealBannedDecisionFragment, (C17060uT) generatedComponent());
            banAppealBannedDecisionFragment.A02 = C16150sX.A1A(A012);
            banAppealBannedDecisionFragment.A00 = C16150sX.A0T(A012);
        }
    }
