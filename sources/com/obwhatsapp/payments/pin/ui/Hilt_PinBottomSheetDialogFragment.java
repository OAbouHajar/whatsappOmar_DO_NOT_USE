...
public abstract class Hilt_PinBottomSheetDialogFragment extends RoundedBottomSheetDialogFragment {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.payments.pin.ui.Hilt_PinBottomSheetDialogFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            C16150sX A0P = AnonymousClass3K2.A0P(pinBottomSheetDialogFragment, (C17060uT) generatedComponent());
            pinBottomSheetDialogFragment.A08 = C16150sX.A0U(A0P);
            pinBottomSheetDialogFragment.A09 = C16150sX.A0Z(A0P);
            pinBottomSheetDialogFragment.A0A = (C118915vc) A0P.AHj.get();
        }
    }
}
