...
public abstract class Hilt_PaymentTypePickerFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.payments.ui.Hilt_PaymentTypePickerFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (this instanceof Hilt_BrazilPaymentTypePickerFragment) {
            ...
            if (!hilt_BrazilPaymentTypePickerFragment.A02) {
                ...
                C16150sX.A1E(((C17050uS) ((C17060uT) hilt_BrazilPaymentTypePickerFragment.generatedComponent())).A0b, hilt_BrazilPaymentTypePickerFragment);
            }
        } else if (!this.A02) {
            this.A02 = true;
