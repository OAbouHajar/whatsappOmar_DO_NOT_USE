...
public abstract class Hilt_IndiaUpiSimPickerDialogFragment extends WaDialogFragment {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.payments.ui.Hilt_IndiaUpiSimPickerDialogFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1J() {
        if (!this.A02) {
            ...
            AnonymousClass3K2.A18(r1, indiaUpiSimPickerDialogFragment);
            indiaUpiSimPickerDialogFragment.A00 = (C16040sK) r1.ADr.get();
            indiaUpiSimPickerDialogFragment.A01 = C110105dW.A0O(r1);
        }
    }
