...
public abstract class Hilt_IndiaUpiMyQrFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r4) {
        ...
        L_0x000f:
            ...
            r0 = r3
            com.obwhatsapp.payments.ui.IndiaUpiMyQrFragment r0 = (com.obwhatsapp.payments.ui.IndiaUpiMyQrFragment) r0
            X.0uS r1 = (X.C17050uS) r1
            r1.A0A(r0)
        L_0x0029:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.payments.ui.Hilt_IndiaUpiMyQrFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A16(Context context) {
        ...
        if (!this.A02) {
            this.A02 = true;
            ((C17050uS) ((C17060uT) generatedComponent())).A0A((IndiaUpiMyQrFragment) this);
        }
    }
