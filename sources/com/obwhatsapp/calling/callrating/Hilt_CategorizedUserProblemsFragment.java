...
public abstract class Hilt_CategorizedUserProblemsFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.calling.callrating.Hilt_CategorizedUserProblemsFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            C16150sX.A1E(r2.A0b, categorizedUserProblemsFragment);
            categorizedUserProblemsFragment.A01 = C17270uo.A00(r2.A0Y.A1i);
        }
    }
