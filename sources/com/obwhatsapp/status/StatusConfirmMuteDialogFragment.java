...
public class StatusConfirmMuteDialogFragment extends Hilt_StatusConfirmMuteDialogFragment {
    ...
    public static /* synthetic */ void A02(UserJid userJid, StatusConfirmMuteDialogFragment statusConfirmMuteDialogFragment) {
        ...
        AnonymousClass1L1 r4 = statusConfirmMuteDialogFragment.A04;
        String string = statusConfirmMuteDialogFragment.A04().getString("message_id");
        r4.A0F.Acl(new AnonymousClass3I8(userJid, r4, 1, Long.valueOf(statusConfirmMuteDialogFragment.A04().getLong("status_item_index")), statusConfirmMuteDialogFragment.A04().getString("psa_campaign_id"), string, statusConfirmMuteDialogFragment.A04().getString("psa_campaign_ids"), statusConfirmMuteDialogFragment.A04().getBoolean("is_message_sampled")));
    ...
    public Dialog A1B(Bundle bundle) {
        ...
        A0R.setTitle(C13690nt.A0c(this, this.A01.A0C(A0A), new Object[1], 0, R.string.str0da5));
        A0R.A06(C13690nt.A0c(this, this.A01.A08(A0A), new Object[1], 0, R.string.str0da4));
        C13690nt.A1H(A0R, this, 102, R.string.str0394);
        AnonymousClass3K4.A0n(A0R, nullable, this, 32, R.string.str0da3);
        return A0R.create();
    }
