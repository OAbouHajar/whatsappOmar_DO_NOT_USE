...
public abstract class Hilt_BusinessApiHomeFragment extends AnonymousClass01A implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r4) {
        ...
        L_0x0010:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.businessapisearch.view.fragment.Hilt_BusinessApiHomeFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            C16150sX r6 = r5.A0b;
            businessApiHomeFragment.A04 = (C14710pd) r6.A05.get();
            businessApiHomeFragment.A06 = (C23061Ai) r6.AC0.get();
            businessApiHomeFragment.A02 = new AnonymousClass2Xo((C82334Ck) r5.A0S.get(), (C82344Cl) r5.A0T.get(), (C82354Cm) r5.A0U.get());
            businessApiHomeFragment.A05 = new AnonymousClass4QK((C18890xQ) r6.APS.get());
            businessApiHomeFragment.A01 = (C82364Cn) r5.A0V.get();
        }
    }
