...
public abstract class Hilt_ContactQrMyCodeFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.qrcode.contactqr.Hilt_ContactQrMyCodeFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            C16150sX r0 = ((C17050uS) ((C17060uT) generatedComponent())).A0b;
            C16150sX.A1E(r0, contactQrMyCodeFragment);
            contactQrMyCodeFragment.A00 = C16150sX.A04(r0);
        }
    }
