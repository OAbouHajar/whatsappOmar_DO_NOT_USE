...
import com.obwhatsapp.shops.ShopsBkFragment;

public abstract class Hilt_PrivacyNoticeFragment extends ShopsBkFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.wabloks.ui.PrivacyNotice.Hilt_PrivacyNoticeFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1H() {
        if (!this.A02) {
            ...
            C16150sX r1 = r3.A0b;
            privacyNoticeFragment.A06 = C17270uo.A00(r1.AJv);
            privacyNoticeFragment.A03 = C17270uo.A00(r3.A00);
            privacyNoticeFragment.A04 = C17270uo.A00(r1.APJ);
        }
    }
