...
public abstract class Hilt_BkScreenFragment extends BkFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.wabloks.base.Hilt_BkScreenFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A1H() {
        if (this instanceof Hilt_BkFcsPreloadingScreenFragment) {
            ...
            if (!hilt_BkFcsPreloadingScreenFragment.A02) {
                ...
                C17050uS r1 = (C17050uS) ((C17060uT) hilt_BkFcsPreloadingScreenFragment.generatedComponent());
                C16150sX r0 = r1.A0b;
                C110105dW.A12(r1, r0, bkFcsPreloadingScreenFragment);
                bkFcsPreloadingScreenFragment.A01 = r0.A1h();
            }
        } else if (!this.A02) {
            this.A02 = true;
            C17050uS r2 = (C17050uS) ((C17060uT) generatedComponent());
            C110105dW.A12(r2, r2.A0b, (BkScreenFragment) this);
        }
    }
