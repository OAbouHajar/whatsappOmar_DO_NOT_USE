...
public abstract class Hilt_CatalogAllCategoryFragment extends WaFragment implements AnonymousClass006 {
    ...
    public void A0y(android.app.Activity r3) {
        ...
        L_0x000f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.obwhatsapp.catalogcategory.view.fragment.Hilt_CatalogAllCategoryFragment.A0y(android.app.Activity):void");
    }
    ...
    public void A19() {
        if (!this.A02) {
            ...
            C16150sX r1 = r0.A0b;
            C16150sX.A1E(r1, catalogAllCategoryFragment);
            catalogAllCategoryFragment.A02 = (AnonymousClass4CY) r0.A0G.get();
            catalogAllCategoryFragment.A01 = AnonymousClass3K3.A0a(r1);
        }
    }
