...
public class C105675As extends Thread {
    public C105675As() {
    ...
    public void run() {
        /*
            r5 = this;
        L_0x0000:
            java.lang.ref.ReferenceQueue r0 = X.AnonymousClass4Z9.A03     // Catch:{ InterruptedException -> 0x0000 }
            java.lang.ref.Reference r4 = r0.remove()     // Catch:{ InterruptedException -> 0x0000 }
            X.5BC r4 = (X.AnonymousClass5BC) r4     // Catch:{ InterruptedException -> 0x0000 }
            r4.destruct()     // Catch:{ InterruptedException -> 0x0000 }
            X.5BC r0 = r4.A01     // Catch:{ InterruptedException -> 0x0000 }
            if (r0 != 0) goto L_0x0030
            X.4Bg r0 = X.AnonymousClass4Z9.A01     // Catch:{ InterruptedException -> 0x0000 }
            ...
            X.5BC r3 = (X.AnonymousClass5BC) r3     // Catch:{ InterruptedException -> 0x0000 }
        L_0x001a:
            if (r3 == 0) goto L_0x0030
            X.5BC r2 = r3.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.4Bf r0 = X.AnonymousClass4Z9.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.5BC r1 = r0.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.5BC r0 = r1.A00     // Catch:{ InterruptedException -> 0x0000 }
            r3.A00 = r0     // Catch:{ InterruptedException -> 0x0000 }
            r1.A00 = r3     // Catch:{ InterruptedException -> 0x0000 }
            X.5BC r0 = r3.A00     // Catch:{ InterruptedException -> 0x0000 }
            r0.A01 = r3     // Catch:{ InterruptedException -> 0x0000 }
            r3.A01 = r1     // Catch:{ InterruptedException -> 0x0000 }
            r3 = r2
            goto L_0x001a
        L_0x0030:
            X.5BC r1 = r4.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.5BC r0 = r4.A01     // Catch:{ InterruptedException -> 0x0000 }
            ...
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C105675As.run():void");
    }
}
