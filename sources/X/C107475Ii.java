...
public class C107475Ii extends C32051fZ implements C33031hp {
    public final byte[] A00;

    public C107475Ii(byte[] bArr) {
        this.A00 = bArr;
    }
    ...
    public boolean A09(C32051fZ r3) {
        if (!(r3 instanceof C107475Ii)) {
            return false;
        }
        return Arrays.equals(this.A00, ((C107475Ii) r3).A00);
    }
