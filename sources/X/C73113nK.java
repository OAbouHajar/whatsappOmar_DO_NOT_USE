...
public final class C73113nK extends C82584Dj {
    public final AnonymousClass4N4 A00;
    public final UserJid A01;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C73113nK(AnonymousClass4N4 r2, UserJid userJid) {
        super(3);
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C73113nK) {
                C73113nK r5 = (C73113nK) obj;
    ...
    public String toString() {
        StringBuilder A0r = AnonymousClass000.A0r("ExpandableCategoryChildItem(categoryData=");
        A0r.append(this.A00);
        A0r.append(", bizJid=");
