...
public class C48922Px extends Thread {
    public C48922Px() {
    ...
    public void run() {
        /*
            r5 = this;
        L_0x0000:
            java.lang.ref.ReferenceQueue r0 = X.C48882Pt.A03     // Catch:{ InterruptedException -> 0x0000 }
            java.lang.ref.Reference r4 = r0.remove()     // Catch:{ InterruptedException -> 0x0000 }
            X.1eR r4 = (X.C31571eR) r4     // Catch:{ InterruptedException -> 0x0000 }
            r4.destruct()     // Catch:{ InterruptedException -> 0x0000 }
            X.1eR r0 = r4.previous     // Catch:{ InterruptedException -> 0x0000 }
            if (r0 != 0) goto L_0x0032
            X.2Pu r0 = X.C48882Pt.A01     // Catch:{ InterruptedException -> 0x0000 }
            ...
            X.1eR r3 = (X.C31571eR) r3     // Catch:{ InterruptedException -> 0x0000 }
        L_0x001a:
            if (r3 == 0) goto L_0x0032
            X.1eR r2 = r3.next     // Catch:{ InterruptedException -> 0x0000 }
            X.2Pv r0 = X.C48882Pt.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.1eR r1 = r0.A00     // Catch:{ InterruptedException -> 0x0000 }
            X.1eR r0 = r1.next     // Catch:{ InterruptedException -> 0x0000 }
            r3.next = r0     // Catch:{ InterruptedException -> 0x0000 }
            r1.next = r3     // Catch:{ InterruptedException -> 0x0000 }
            X.1eR r0 = r3.next     // Catch:{ InterruptedException -> 0x0000 }
        ...
        L_0x002e:
            ...
            goto L_0x001a
        L_0x0032:
            X.1eR r1 = r4.next     // Catch:{ InterruptedException -> 0x0000 }
        ...
        L_0x003a:
            ...
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C48922Px.run():void");
    }
}
