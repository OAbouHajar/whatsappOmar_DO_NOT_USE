...
public final class C58532te extends C28541Wm implements C28561Wp {
    public static final C58532te A04;
    ...
    public final java.lang.Object A0b(X.AnonymousClass2L5 r9, java.lang.Object r10, java.lang.Object r11) {
        ...
        L_0x0011:
            ...
            java.lang.Class<X.2te> r1 = X.C58532te.class
            monitor-enter(r1)
            X.2Kz r0 = A05     // Catch:{ all -> 0x0026 }
            if (r0 != 0) goto L_0x0024
            X.2te r0 = A04     // Catch:{ all -> 0x0026 }
        ...
        L_0x005b:
            ...
            X.2tG r0 = (X.C58292tG) r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wr r1 = r0.A0U()     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.3dH r1 = (X.C68343dH) r1     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
        L_0x0069:
            X.2tG r0 = X.C58292tG.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
        ...
        L_0x0081:
            ...
            java.lang.Object r0 = r8.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.2tH r0 = (X.C58302tH) r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wr r1 = r0.A0U()     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.3dJ r1 = (X.C68363dJ) r1     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
        L_0x008f:
            X.2tH r0 = X.C58302tH.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wo r0 = X.C28541Wm.A0H(r10, r11, r0)     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            r8.A03 = r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            goto L_0x009a
        L_0x0098:
        ...
        L_0x00a7:
            ...
            java.lang.Object r0 = r8.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.2t1 r0 = (X.AnonymousClass2t1) r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wr r1 = r0.A0U()     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.3dI r1 = (X.C68353dI) r1     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
        L_0x00b5:
            X.2t1 r0 = X.AnonymousClass2t1.A02     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wo r0 = X.C28541Wm.A0H(r10, r11, r0)     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            r8.A03 = r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            goto L_0x00c0
        L_0x00be:
        ...
        L_0x013c:
            ...
            goto L_0x0112
        L_0x0147:
            X.42Z r0 = X.AnonymousClass42Z.A02
            goto L_0x010b
        L_0x014a:
            X.42Z r0 = X.AnonymousClass42Z.A04
            goto L_0x010b
        L_0x014d:
            X.42Z r0 = X.AnonymousClass42Z.A03
            goto L_0x010b
        L_0x0150:
            X.42Z r0 = X.AnonymousClass42Z.A01
            goto L_0x010b
        L_0x0153:
            X.3dG r0 = new X.3dG
            r0.<init>()
        ...
        L_0x015d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C58532te.A0b(X.2L5, java.lang.Object, java.lang.Object):java.lang.Object");
    }
