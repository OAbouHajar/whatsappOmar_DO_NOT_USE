...
public final class C73133nM extends C82584Dj {
    public final AnonymousClass4N4 A00;
    public final UserJid A01;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C73133nM(AnonymousClass4N4 r2, UserJid userJid) {
        super(6);
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C73133nM) {
                C73133nM r5 = (C73133nM) obj;
    ...
    public String toString() {
        StringBuilder A0r = AnonymousClass000.A0r("SearchContextCategoryListDisplayItem(categoryData=");
        A0r.append(this.A00);
        A0r.append(", bizJid=");
