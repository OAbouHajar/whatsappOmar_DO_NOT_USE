...
public final class AnonymousClass2u0 extends C28541Wm implements C28561Wp {
    public static final AnonymousClass2u0 A04;
    ...
    static {
        AnonymousClass2u0 r0 = new AnonymousClass2u0();
        A04 = r0;
        r0.A0W();
    }
    ...
    public final java.lang.Object A0b(X.AnonymousClass2L5 r9, java.lang.Object r10, java.lang.Object r11) {
        ...
        L_0x0011:
            ...
            java.lang.Class<X.2u0> r1 = X.AnonymousClass2u0.class
            monitor-enter(r1)
            X.2Kz r0 = A05     // Catch:{ all -> 0x0026 }
            if (r0 != 0) goto L_0x0024
            X.2u0 r0 = A04     // Catch:{ all -> 0x0026 }
        ...
        L_0x005b:
            ...
            X.2tZ r0 = (X.C58482tZ) r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wr r1 = r0.A0U()     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.3el r1 = (X.C69263el) r1     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
        L_0x0069:
            X.2tZ r0 = X.C58482tZ.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
        ...
        L_0x0081:
            ...
            java.lang.Object r0 = r8.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.2tb r0 = (X.C58502tb) r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wr r1 = r0.A0U()     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.3en r1 = (X.C69283en) r1     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
        L_0x008f:
            X.2tb r0 = X.C58502tb.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wo r0 = X.C28541Wm.A0H(r10, r11, r0)     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            r8.A03 = r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            goto L_0x009a
        L_0x0098:
        ...
        L_0x00a7:
            ...
            java.lang.Object r0 = r8.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.2ta r0 = (X.C58492ta) r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wr r1 = r0.A0U()     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.3em r1 = (X.C69273em) r1     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
        L_0x00b5:
            X.2ta r0 = X.C58492ta.A03     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            X.1Wo r0 = X.C28541Wm.A0H(r10, r11, r0)     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            r8.A03 = r0     // Catch:{ 1bD -> 0x00d3, IOException -> 0x00d1 }
            goto L_0x00c0
        L_0x00be:
        ...
        L_0x00e0:
            ...
            X.2u0 r11 = (X.AnonymousClass2u0) r11
            int r0 = r8.A00
            r1 = 8
            r0 = r0 & 8
        ...
        L_0x013c:
            ...
            goto L_0x0112
        L_0x0147:
            X.42f r0 = X.C800142f.A02
            goto L_0x010b
        L_0x014a:
            X.42f r0 = X.C800142f.A04
            goto L_0x010b
        L_0x014d:
            X.42f r0 = X.C800142f.A03
            goto L_0x010b
        L_0x0150:
            X.42f r0 = X.C800142f.A01
            goto L_0x010b
        L_0x0153:
            X.3ek r0 = new X.3ek
            r0.<init>()
        ...
        L_0x015d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass2u0.A0b(X.2L5, java.lang.Object, java.lang.Object):java.lang.Object");
    }
