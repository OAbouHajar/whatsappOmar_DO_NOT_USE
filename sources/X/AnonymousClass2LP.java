...
public final class AnonymousClass2LP extends C28541Wm implements C28561Wp {
    public static final AnonymousClass2LP A05;
    ...
    static {
        AnonymousClass2LP r0 = new AnonymousClass2LP();
        A05 = r0;
        r0.A0W();
    }

    public AnonymousClass2LP() {
    ...
    public int AFw() {
        ...
        if ((i4 & 2) == 2) {
            i3 += CodedOutputStream.A02(2, this.A01);
        }
        if ((i4 & 4) == 4) {
            i3 += CodedOutputStream.A02(3, this.A02);
        }
        if ((i4 & 8) == 8) {
