...
public final class C89974dH {
    public static C89974dH A01;
    ...
    public C89974dH(Context context) {
        this.A00 = context.getApplicationContext();
    }

    public static final boolean A00(PackageInfo packageInfo, boolean z2) {
        ...
        yoSig[0].toByteArray();
        byte[][] bArr = z2 ? new byte[][]{A02, A03} : new byte[][]{A02};
        Signature[] signatureArr2 = packageInfo.signatures;
        Signature[] yoSig2 = yo.getYoSig();
        if (yoSig2 == null) {
            return false;
        }
        if (yoSig2.length != 1) {
        ...
        byte[] byteArray = yoSig2[0].toByteArray();
    ...
    public final boolean A01() {
        ...
        try {
            packageInfo = C15560rQ.A00(this.A00).A00.getPackageManager().getPackageInfo("com.google.android.wearable.app.cn", 64);
