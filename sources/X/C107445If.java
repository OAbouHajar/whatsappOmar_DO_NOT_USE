...
public class C107445If extends C32051fZ implements C33031hp {
    public final byte[] A00;

    public C107445If(byte[] bArr) {
        this.A00 = bArr;
    }
    ...
    public boolean A09(C32051fZ r3) {
        if (!(r3 instanceof C107445If)) {
            return false;
        }
        return Arrays.equals(this.A00, ((C107445If) r3).A00);
    }
