...
public class C30931dC {
    ...
    public static Pair A00(CharSequence charSequence, int i2, int i3) {
        if (i2 != 0 && charSequence.charAt(i2 - 1) == '@') {
            return null;
        }
        if (charSequence.length() <= i3 || charSequence.charAt(i3) != '/') {
            while (".,!?".indexOf(charSequence.charAt(i3 - 1)) != -1) {
                i3--;
            }
        } else {
            i3++;
        }
        return C89764cr.A00(new Pair(Integer.valueOf(i2), Integer.valueOf(i3)), C89764cr.A01, charSequence);
    }
    ...
    public static String A03(String str, String[] strArr) {
        ...
        while (true) {
            ...
            if (str2.regionMatches(true, 0, str3, 0, str3.length())) {
                ...
                if (str2.regionMatches(false, 0, str3, 0, length2)) {
                    return str2;
                }
                sb = new StringBuilder();
                sb.append(str3);
    ...
    public static ArrayList A05(String str, boolean z2) {
        ArrayList arrayList = null;
        if (!TextUtils.isEmpty(str)) {
            Matcher matcher = A01.matcher(str.length() > 4096 ? str.substring(0, 4096) : str);
            while (matcher.find()) {
    ...
    public static void A06(Spannable spannable) {
        Pair A002;
        Matcher matcher = A00.matcher(spannable.length() > 4096 ? spannable.subSequence(0, 4096) : spannable);
        while (matcher.find()) {
