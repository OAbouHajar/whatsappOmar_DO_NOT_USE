...
public class AnonymousClass5C8 extends HashMap<String, Integer> {
    public AnonymousClass5C8() {
        Integer valueOf = Integer.valueOf(R.drawable.large_2764_fe0f);
        put("️", valueOf);
        put("❤", valueOf);
        ...
        put("❤‍🔥", Integer.valueOf(R.drawable.large_2764_fe0f_200d_1f525));
    }
}
